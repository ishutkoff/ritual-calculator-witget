<template>
	<div class="calculator-tabs">
		<div class="calculator-tabs-wrapper">
			<div
				@click="setType(BURIAL)"
				class="calculator-tabs-item"
				:class="
					$store.state.serviceType === BURIAL
						? 'calculator-tabs-item--selected'
						: ''
				"
			>
				<svg
		...
		<div class="calculator-body">
			...
			<div class="calculator-products-groups">
				<div
					v-for="productCategory of getProductsCategories"
					:key="productCategory._id"
					class="calculator-products-groups__item"
				>
					<div
						class="calculator-products-groups__image"
						:class="
...
168 185 29 76 24 186 -10 258 -34 69 -108 138 -175 163 -74 28 -180 27 -253 0z"
					...
					<div>
						...
						/>
						<div
							v-if="$store.state.orderList[createIndex(productCategory._id)]"
						...
						>
							...
							<span
								...
								"
								class="calculator-products-groups__remove-btn"
								>Отменить выбор</span
							>
						</div>
					</div>
			...
			<div class="calculator-products-without-group">
				<div
					v-for="product of getProductsWithOutCategory"
					:key="product._id"
		...
		<div class="calculator-body">
			...
			<div class="calculator-services-group">
				<div
					v-for="serviceCategory of getServicesCategories"
					:key="serviceCategory._id"
					class="calculator-services-without-group__item"
				>
					<calculator-select
						:items="serviceCategory.services"
			...
			<div class="calculator-services-without-group">
				<div
					v-for="service of getServicesWithOutCategory"
					:key="service._id"
					class="calculator-services-without-group__item"
				>
					<div>
